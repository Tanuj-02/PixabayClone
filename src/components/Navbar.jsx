...
const Navbar = () => {
  ...
  return (
    <div className='h-1/12  flex items-center justify-between p-2 fixed top-0 left-0 w-full z-50 bg-black/30 backdrop-blur-md border-b border-white/10 flex-wrap'>
